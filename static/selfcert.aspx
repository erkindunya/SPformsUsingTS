    ...
    <div class="form-panel row">
        <div class="col-sm border rounded bg-light p-5 m-5">
            <div class="text-center mb-5">
                <h1>Self-certification of sickness absence record</h1>
            ...
            <form id="SelfCertForm" >
                ...
                <fieldset class="form-group col-xs-12">
                    <legend>Was the absence caused by an injury at work?</legend>
                    ...
                    <span class="form-text text-muted">Employees should note that if absence is due to an injury received at their place of work, it is
                        their responsibility to ensure that an accurate entry has been made in the Accident Book (BI
                        510) kept at their place of work.</span>
                </fieldset>
                    <fieldset class="form-group col-lg-4">
                        <legend>Did you attend hospital?</legend>
                        <div class="form-check form-check-inline">
                    ...
                    <fieldset class="form-group col-lg-4">
                        <legend>Did you attend a clinic?</legend>
                        <div class="form-check form-check-inline">
                    ...
                    <fieldset class="form-group col-lg-4">
                        <legend>Did you attend a doctor?</legend>
                        <div class="form-check form-check-inline">
