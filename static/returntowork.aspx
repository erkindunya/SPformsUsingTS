...
<asp:content ContentPlaceholderID="PlaceHolderMain" runat="server">
        ...
        <div id="return-to-work-form" class="form-panel">
            <div class="col-sm border rounded bg-light p-5 m-5">
                ...
                <fieldset>
                    <legend class="col-xs-12">Employee details</legend>
                    <div class="form-row">
                ...
                <fieldset class="form-group col-xs-12">
                    <legend>Did the employee properly notify the employer of his/her absence in accordance with the managing sickness
                ...
                <fieldset class="form-group col-xs-12">
                    <legend>If the employee consulted his/her GP, are there any recommendations on a fit note as to a phased return
                ...
                <fieldset class="form-group col-xs-12">
                    <legend>Are there any further absences/appointments anticipated?</legend>
                    <div class="form-check form-check-inline">
                ...
                <fieldset class="form-group col-xs-12">
                    <legend>Has the employee identified any measures to help him/her?</legend>
                    <div class="form-check form-check-inline">
                ...
                <fieldset class="form-group col-xs-12">
                    <legend>Has the employee identified anything within his/her work environment that contributed to the absence?</legend>
                    <div class="form-check form-check-inline">
                ...
                <div class="form-row">
                    <legend class="col-xs-12"> Has the employee met any trigger points as outlined in the Managing Sickness Absence Procedure:</legend>
                    <fieldset class="form-group  col-lg-4">
                        <legend> 14 or more calendar days of sickness absence (referral to occupational health required)</legend>
                        <div class="form-check form-check-inline">
                    ...
                    <fieldset class="form-group  col-lg-4">
                        <legend> 3 periods of sickness absence in a 3 month period</legend>
                        <div class="form-check form-check-inline">
                    ...
                    <fieldset class="form-group  col-lg-4">
                        <legend>4 or more periods of sickness absence in a rolling 12 month period beginning on the first day of
                            absence</legend>
                        <div class="form-check form-check-inline">
